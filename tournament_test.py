...
#
# If you do add any of the extra credit options, be sure to add/modify
# these test cases
...
def testCount():
    ...
    print ("1. countPlayers() returns 0 after initial"
...
def testPairings():
    """
    Test that pairings are generated properly both before and after
    match reporting.
    """
    deleteMatches()
    deletePlayers()
